...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="This program extracts statements wich have an item value. Writes it to <prefix>statement_occurences.data and <prefix>statement_pair_occurences.data")
